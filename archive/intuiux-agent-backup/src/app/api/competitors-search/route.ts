...
const COMPETITORS_KNOWLEDGE_BASE: Record<string, {
  ...
  crm: {
    russian: [
      {
        name: 'Битрикс24',
        url: 'https://bitrix24.ru',
        description: 'Комплексная CRM-платформа с бесплатным тарифом для малого бизнеса.',
        features: ['CRM', 'Задачи', 'Сайт', 'Интернет-магазин', 'Чат', 'Видеозвонки'],
        pricing: 'Бесплатно до 5 чел / от 2490₽/мес',
        strengths: ['Бесплатный тариф', 'Всё в одном', 'Интеграции', 'Локализация'],
        weaknesses: ['Перегруженность', 'Сложность', 'Медленная работа', 'Сложный UI']
      },
      {
        name: 'AmoCRM',
        url: 'https://amocrm.ru',
        description: 'Простая CRM для управления продажами с интуитивной воронкой.',
        features: ['Воронка продаж', 'Интеграции', 'Аналитика', 'Мессенджеры', 'Автоматизация'],
        pricing: 'от 799₽/мес',
        strengths: ['Простота', 'UX', 'Воронка продаж', 'Быстрый старт'],
        weaknesses: ['Ограниченный функционал', 'Нет задач', 'Цена растёт с пользователями']
      },
      {
        name: 'Megaplan',
        url: 'https://megaplan.ru',
        description: 'CRM и управление проектами для малого и среднего бизнеса.',
        features: ['CRM', 'Задачи', 'Проекты', 'Отчёты', 'Интеграции'],
        pricing: 'от 750₽/мес',
        strengths: ['Баланс CRM и задач', 'Простота', 'Цена', 'Поддержка'],
        weaknesses: ['Меньше интеграций', 'Ограниченная автоматизация']
      },
      {
        name: 'RetailCRM',
        url: 'https://retailcrm.ru',
        description: 'CRM для интернет-магазинов и розничной торговли.',
        features: ['CRM', 'Заказы', 'Интеграции с маркетплейсами', 'Аналитика', 'Мультиканальность'],
        pricing: 'от 1500₽/мес',
        strengths: ['E-commerce специализация', 'Маркетплейсы', 'Аналитика'],
        weaknesses: ['Только для торговли', 'Сложность', 'Цена']
      }
    ],
    international: [
      {
        ...
        features: ['Sales Cloud', 'Service Cloud', 'Marketing Cloud', 'AI Einstein', 'AppExchange'],
        pricing: 'от $25/мес',
        strengths: ['Мощность', 'Экосистема', 'AI', 'Enterprise'],
        weaknesses: ['Высокая цена', 'Сложность', 'Нет русского', 'Санкции']
      },
      {
        name: 'HubSpot CRM',
        url: 'https://hubspot.com',
        description: 'Бесплатная CRM с платными модулями для роста.',
        features: ['CRM', 'Marketing', 'Sales', 'Service', 'CMS', 'Operations'],
        pricing: 'Бесплатно / от $45/мес',
        strengths: ['Free tier', 'All-in-one', 'UX', 'Integrations'],
        weaknesses: ['Expensive add-ons', 'Limited free', 'Санкции']
      },
      {
        name: 'Pipedrive',
        url: 'https://pipedrive.com',
        description: 'Sales-focused CRM для малого бизнеса.',
        features: ['Pipeline', 'Activities', 'Email', 'Reports', 'Automation'],
        pricing: 'от $15/мес',
        strengths: ['Sales focus', 'UX', 'Mobile', 'Integrations'],
        weaknesses: ['Limited features', 'No Russian', 'Санкции']
      }
    ],
    marketTrends: [
      'AI-прогнозирование продаж',
    ...
    marketSize: '$80 млрд глобально, $500 млн в РФ (2024)'
  },
...
function detectCategory(ideaText: string): string {
  ...
  // Онлайн-запись / Календарь записи (проверяем ПЕРВЫМ!)
  ...
  // E-commerce / Интернет-магазин (проверяем ВТОРЫМ!)
...
function generateSWOT(comp: {
  ...
  return {
    ...
    opportunities: [
      `Дифференциация через улучшенный UX`,
      `Лучшее соотношение цена/функционал`,
      `Специализация на нишевом сегменте`,
      `Локальные интеграции`
    ],
    threats: [
      `Конкуренция по цене`,
      `Устоявшиеся привычки пользователей`,
      `Бренд и экосистема конкурента`,
      `Сетевой эффект`
    ]
  };
}
